## PDF 파일에 있는 테이블 내용도 텍스트로 변환하는 버전의 프로그램
##
import pdfplumber
...
#txt_output_path = r"C:\\data\\rfp_txt\\SR-MaaS 통합정보시스템-감리.txt"
#pdf_output_path = r"C:\\data\\rfp_pdf\\SR-MaaS 통합정보시스템-감리_output.pdf"
